---
title: "cs231n-note-6"
date: 2018-07-29T15:06:19.000Z
slug: "cs231n-note-6"
summary: "神经网络笔记2 设置数据和模型 神经网络就是进行了一系列的线性映射与非线性激活函数交织的运算, 这些做法共同定义了评分函数(score function) 数据预处理 3个常用的符号，数据矩阵X，假设其尺寸是[N x D]（N是数据样本的数量，D是数据的维度） 均值减法(Mean subtraction): 每个独立特征减去平均值，从几何上可以理解为在每个维度上都将数据云的中心..."
tags: []
legacyPath: "/2018/07/29/cs231n-note-6/"
legacyTopLevelPaths: []
legacyTagSlugs: []
---
# 神经网络笔记2
