---
title: "cs231n note - 2"
date: 2018-05-21T14:56:48.000Z
slug: "cs231n-note-2"
summary: "Reference: Linear Classification score function (评分函数) 原始图片到各个类别的评分情况， 分越高越接近 每个图像都是 [D x 1] D = pixel X pixel X 3(RGB) 参数 权重 W (weight) = [k X D] k是样本数 在维度空间里 做旋转变换 偏差向量 b (bias vector) = [..."
tags:
  - "Machine_Learning"
legacyPath: "/2018/05/21/cs231n-note-2/"
legacyTopLevelPaths: []
legacyTagSlugs: []
---
Reference:
